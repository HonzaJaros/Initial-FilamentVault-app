// pages/index.js - Main App Component
...
export default function FilamentVault() {
  ...
  useEffect(() => {
    ...
    if (savedSpools) setSpools(JSON.parse(savedSpools));
    if (savedHistory) setUsageHistory(JSON.parse(savedHistory));
  }, []);
        ...
        <div className="px-4 py-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-cyan-500 hover:bg-cyan-400 text-slate-950 py-2 rounded font-bold text-sm"
            >
              <Plus size={16} />
              Add Spool
            </button>
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2 rounded font-bold text-sm ${
                nfcStatus === 'ready' ? 'bg-blue-500 hover:bg-blue-400' : 'bg-slate-700'
              } text-slate-950`}
            >
              <Radio size={16} />
      ...
      <div className="sticky top-20 bg-slate-900/80 border-b border-slate-700/50 px-4 py-2 flex gap-2 overflow-x-auto">
        <button
          ...
          className={`px-4 py-2 rounded font-bold text-sm whitespace-nowrap ${
            !showHistory ? 'bg-cyan-500 text-slate-950' : 'bg-slate-700 text-slate-300'
          }`}
        >
          Inventory
        </button>
        <button
          ...
          className={`px-3 py-2 rounded font-bold text-sm whitespace-nowrap ${
            !showHistory && filterStatus === 'good' ? 'bg-cyan-500 text-slate-950' : 'bg-slate-700 text-slate-300'
          }`}
        >
          ✓ In Stock
        </button>
        <button
          ...
          className={`px-3 py-2 rounded font-bold text-sm whitespace-nowrap ${
            !showHistory && filterStatus === 'low' ? 'bg-cyan-500 text-slate-950' : 'bg-slate-700 text-slate-300'
          }`}
        >
          ⚡ Low
        </button>
        <button
          ...
          className={`px-3 py-2 rounded font-bold text-sm whitespace-nowrap flex items-center gap-1 ${
            showHistory ? 'bg-cyan-500 text-slate-950' : 'bg-slate-700 text-slate-300'
          }`}
        >
          <History size={16} />
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1 bg-slate-700 hover:bg-slate-600 text-slate-300 py-2 rounded text-sm font-bold"
                      >
                        <Edit2 size={14} />
                        Edit
                      </button>
                      ...
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-1 bg-blue-600 hover:bg-blue-500 text-white py-2 rounded text-sm font-bold"
                      >
                        <Radio size={14} />
                        NFC
                      </button>
                      <button
                        ...
                        className="px-3 flex items-center justify-center bg-red-600/20 hover:bg-red-600/40 text-red-400 py-2 rounded text-sm font-bold"
                      >
                        <Trash2 size={14} />
                      </button>
                    </div>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 border-t border-slate-700/50 w-full rounded-t-2xl p-6 max-h-[90vh] overflow-y-auto">
                ...
                <div key={field.key}>
                  ...
                  {field.type === 'select' ? (
                    <select
                      ...
                      className="w-full bg-slate-700/50 border border-slate-600/50 rounded px-3 py-2 text-slate-200"
                    >
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 bg-slate-700 hover:bg-slate-600 text-slate-300 py-2 rounded font-bold"
              >
                Cancel
              </button>
              <button
                onClick={handleSave}
                className="flex-1 bg-cyan-500 hover:bg-cyan-400 text-slate-950 py-2 rounded font-bold"
              >
                Save
              </button>
            </div>
